...
const AdminDashboard = () => {
   ...
   const kpiData = [
      ...
      { label: "Active Learners", value: stats.totalUsers, icon: HiUsers, color: "purple", change: "+8.3%", up: true },
         ...
         <Box bg={useColorModeValue("gray.50", "gray.900")} minH="100vh" py={10} px={{ base: 4, lg: 12 }}>
            ...
            <Flex mb={10} align="center" justify="space-between" direction={{ base: "column", md: "row" }} gap={6}>
               <VStack align="start" spacing={1}>
                  ...
                  <Heading size="xl" fontWeight="black" letterSpacing="tight">Dashboard</Heading>
