...
const seedData = async () => {
  try {
    ...
    const tech = await Category.create({
      name: 'Technology',
      description: 'Everything about tech and innovation',
      icon: 'HiTerminal',
    });
    const design = await Category.create({
      name: 'Design',
      description: 'Visual arts and user experience',
      icon: 'HiPencilAlt',
    });
    ...
    const uiux = await Category.create({
      name: 'UI/UX Design',
      parent: design._id,
    ...
    const marketing = await Category.create({
    ...
    const products = [
      {
        ...
        description:
          'Premium height-adjustable wooden desk for professional engineers.',
        price: 185000,
        category: 'Furniture',
        image: '/img/desk.png',
      },
      {
        ...
        description:
          'Ultra-responsive tactile feedback with customizable RGB lighting.',
        price: 55000,
        category: 'Tech',
      ...
      },
      {
        ...
        description: 'Breathable mesh with 4D lumbar support.',
        price: 110000,
        category: 'Furniture',
        image: '/img/chair.png',
      },
    ...
    const courses = [
      {
        ...
        description:
          'Build production-ready applications with the latest React features.',
        price: 85000,
        category: webDev._id,
        level: 'Advanced',
        instructor: {
          ...
          bio: '15 years of web experience.',
        },
      ...
      },
      {
        title: 'Figma to Code',
        description:
          'Transform your designs into high-fidelity Chakra UI components.',
        price: 75000,
        category: uiux._id,
        level: 'Intermediate',
        instructor: {
            ...
            subSections: [
              {
                ...
                units: [
                  ...
                  },
                  {
                    ...
                    type: 'text',
                    content:
                      '<h1>Grid vs Flex</h1><p>Comparison of layout models...</p>',
                    duration: '12:00',
                    isFree: false,
                  },
                ],
      ...
      enrolledCourses: [
        {
          ...
          progress: 25,
          completedUnits: [
            createdCourses[0].sections[0].subSections[0].units[0]._id,
          ],
        },
      ],
      preferences: {
